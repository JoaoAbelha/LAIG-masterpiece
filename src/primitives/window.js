...
class windowObject extends CGFobject {
	constructor(scene, distortion, size, background) {
        ...
        this.shader.setUniformsValues({distortion: 0, background :1 , timefactor1: 0, resolutionWidth:  this.scene.gl.canvas.width,
	...
	display() {
        ...
        this.scene.activeShader.setUniformsValues({timefactor1: (this.scene.time / 30000 % 1000) });
