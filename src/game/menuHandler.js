class MenuHandler {
    static init(scene) {
        ...
        let player2_computer_level_menu = new Menu (scene, 
            [
        ...
        let player2_type_menu = new Menu(scene, 
            [
        ...
        let player1_computer_level_menu = new Menu ( scene, 
            [
    ...
    static clockSpeedMenu() {
        let clock_speed_menu = new Menu (this.scene, 
            [
